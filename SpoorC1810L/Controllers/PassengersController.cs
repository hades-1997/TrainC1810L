...
namespace TrainC1810L.Controllers
{
    public class PassengersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Gender,Total,DateOfTravel,Class")] Passenger passenger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Gender,Total,DateOfTravel,Class")] Passenger passenger)
        {
            if (id != passenger.Id)
            {
                return NotFound();
